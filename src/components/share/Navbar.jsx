      ...
      <div className="container mx-auto flex items-center justify-between  px-6">
        ...
        <div className="flex items-center space-x-4">
...

          {
            user ?
              // <Link href={'/myprofile'}>
              //   <Button className='w-fit' style={{ backgroundColor: '#DBBC7E', color: '#262626', fontSize: '14px', fontWeight: '700', height: "40px" }}>
              //     <Avatar size={30}>
              //     <Image alt='profile' height={30} width={30} src={user?.image} />
              //   </Avatar>   {user?.name}</Button>
              // </Link>
              <Dropdown overlay={usermenuitem} trigger={['click']} placement="bottomRight">
              <Button
                className="w-fit"
                style={{
              ...
              <Link href={'/auth/signin'}>
                <Button style={{ backgroundColor: '#DBBC7E', color: '#262626', height: "40px" }} className="bg-secondary text-primary border-none text-[16px] font-bold">
                  Login
                </Button>
              </Link>
          }
