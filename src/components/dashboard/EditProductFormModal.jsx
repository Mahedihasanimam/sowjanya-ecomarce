...
import {  useUpdateproductMutation } from "@/redux/features/admin/productSlice";
...
const ProductFormModal = ({
  ...
  const [fileList, setFileList] = useState(initialData?.images || []);
  ...
  const handleSubmit = () => {
    form
      ...
      .then((values) => {
        ...
        updateProduct({data:formData,id:initialData?.id}).then((res) => {
