...
export default function ProductTable() {
  ...
  const columns = [
    ...
    },
    {
      ...
      key: "price",
      render: (price) => (
        <span className="text-[#DBBC7E] text-[16px] font-medium">{price}</span>
      ),
    },
    {
      title: "Quantity",
    ...
    {
      title: "Sale",
      dataIndex: "no_of_sale",
      key: "no_of_sale",
      render: (sale) => (
        <span className="text-[#D1D0D0] text-[16px] font-medium">{sale}</span>
      ),
    },
    {
      title: "Stock",
      ...
      render: (stock) => (
        <span
          className={
            stock === "In Stock"
              ? "text-[#00FF55] txt-[16px] font-medium"
              : "text-[#FF6767] txt-[16px] font-medium"
          }
        >
          {stock}
        </span>
  ...
  const [sortStock, setSortStock] = useState("All");
  ...
  const sortItems = [
    ...
    },
    {
      key: "Stock Out",
      label: "Stock Out",
      onClick: () => setSortStock("Stock Out"),
    },

    {
      key: "In Stock",
      label: "In Stock",
      onClick: () => setSortStock("In Stock"),
    },
  ];
  return (
    <div className="min-h-screen bg-[#141414] p-6">
      ...
      <Table
        ...
        pagination={{
          ...
          total: allProducts?.products?.total,
