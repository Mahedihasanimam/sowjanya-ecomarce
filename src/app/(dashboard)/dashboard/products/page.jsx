...
import { Table, Input, Button, Select, Dropdown ,Modal } from 'antd'
import { SearchOutlined, EyeOutlined, EditOutlined, DeleteOutlined, PlusOutlined, MenuOutlined, ExclamationCircleOutlined } from '@ant-design/icons'
...
export default function ProductTable() {
    ...
    const [isEdittModalVisible, setIsEditModalVisible] = useState(false)
    const [edittModalMode, seteditModalMode] = useState('edit')
        ...
        },
        {
            ...
            render:(_, record) => (
                <div className="flex gap-3">
                    <button   onClick={()=>handleViewClick(record)}  className="text-gray-400 hover:text-white">
                    ...
                    <button onClick={() => handleedit(record)} className="text-gray-400 hover:text-white">
                    ...
                    <button  onClick={() => handleDelete(record.key)} className="text-gray-400 hover:text-red-500">
        ...
        <div className="min-h-screen bg-[#141414] p-6">
            ...
            <div className="flex items-center justify-between py-4 gap-4 w-full sm:w-auto">
                ...
                onClick={handleAddNew}
                    style={{ border: '1px solid #DBBC7E', backgroundColor: '#000000', color: '#DBBC7E', height: '42px', width: '298px', fontSize: '20px', fontWeight: '500' }}
            ...
            <Table
                ...
                pagination={{
                    ...
                    itemRender: (page, type, originalElement) => {
                        if (type === 'prev') {
                            return <button className="px-3 py-1 rounded border border-gray-600 hover:border-white"><svg width="11" height="19" viewBox="0 0 11 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M0.425972 8.44461L8.6597 0L10.7178 2.11078L3.51308 9.5L10.7178 16.8892L8.6597 19L0.425972 10.5554C0.15311 10.2755 -0.000177383 9.89583 -0.000177383 9.5C-0.000177383 9.10417 0.15311 8.72455 0.425972 8.44461Z" fill="white" />
                            </svg>
                            </button>
                        }
                        if (type === 'next') {
                            return <button className="px-3 py-1 rounded border border-gray-600 hover:border-white"><svg width="11" height="19" viewBox="0 0 11 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M10.2918 10.5554L2.05807 19L0 16.8892L7.2047 9.5L0 2.11078L2.05807 0L10.2918 8.44461C10.5647 8.72455 10.718 9.10417 10.718 9.5C10.718 9.89583 10.5647 10.2755 10.2918 10.5554Z" fill="white" />
                            </svg>
                            </button>
                        }
                        return (
