...
export default function ProductTable() {
    ...
    const columns = [
        ...
        },
        {
            ...
            dataIndex: 'email',
            key: 'email',
            render: (email) => <span className='text-[#D1D0D0] text-[16px] font-medium'>{email}</span>,
        },
        {
            title: 'ID',
            dataIndex: 'ID',
            key: 'ID',
            render: (ID) => <span className='text-[#D1D0D0] text-[16px] font-medium'>{ID}</span>,
        },
        {
            title: 'Bought product',
            dataIndex: 'Boughtproduct',
            key: 'Boughtproduct',
            render: (Boughtproduct) => <span className='text-[#D1D0D0] text-[16px] font-medium'>{Boughtproduct}</span>,
        },
