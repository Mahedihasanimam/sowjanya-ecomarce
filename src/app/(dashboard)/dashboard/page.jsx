    ...
    return (
        <div className="min-h-screen bg-[#141414] p-6">
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <div className="flex items-center gap-2">
                                    <h2 className="text-2xl font-bold text-white m-0">4,654</h2>
                                    <span className="text-green-500 flex items-center text-sm">
                                        <svg width="14" height="9" viewBox="0 0 14 9" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M13.446 0.464775C13.3775 0.281602 13.2465 0.13604 13.0816 0.059971C13.0005 0.0215588 12.9134 0.00118442 12.8252 0H9.45117C9.27221 0 9.10057 0.0789796 8.97402 0.219564C8.84747 0.360148 8.77637 0.550821 8.77637 0.749638C8.77637 0.948454 8.84747 1.13913 8.97402 1.27971C9.10057 1.4203 9.27221 1.49928 9.45117 1.49928H11.1989L7.42676 5.68975L5.20665 3.21595C5.14392 3.14568 5.06929 3.08992 4.98706 3.05186C4.90483 3.0138 4.81663 2.9942 4.72754 2.9942C4.63846 2.9942 4.55026 3.0138 4.46803 3.05186C4.3858 3.08992 4.31116 3.14568 4.24843 3.21595L0.199606 7.71377C0.136358 7.78346 0.0861561 7.86637 0.0518971 7.95772C0.0176382 8.04907 0 8.14705 0 8.24602C0 8.34498 0.0176382 8.44296 0.0518971 8.53431C0.0861561 8.62566 0.136358 8.70857 0.199606 8.77826C0.262338 8.84852 0.336972 8.90429 0.419203 8.94235C0.501434 8.98041 0.589635 9 0.678717 9C0.767799 9 0.856 8.98041 0.938231 8.94235C1.02046 8.90429 1.0951 8.84852 1.15783 8.77826L4.72754 4.80518L6.94765 7.27898C7.01038 7.34925 7.08502 7.40501 7.16725 7.44307C7.24948 7.48113 7.33768 7.50072 7.42676 7.50072C7.51584 7.50072 7.60404 7.48113 7.68628 7.44307C7.76851 7.40501 7.84314 7.34925 7.90587 7.27898L12.1504 2.55626V4.49783C12.1504 4.69664 12.2215 4.88732 12.348 5.0279C12.4746 5.16848 12.6462 5.24746 12.8252 5.24746C13.0042 5.24746 13.1758 5.16848 13.3024 5.0279C13.4289 4.88732 13.5 4.69664 13.5 4.49783V0.749638C13.4989 0.651677 13.4806 0.554899 13.446 0.464775Z" fill="#00FF55" />
                                        </svg>
                    ...
                    <Card className="bg-[#1f1f1f] border-0 h-[124px]">
                        <div className="flex items-center gap-4">
                            <div className="p-3 rounded-lg bg-[#262626]">
                                <svg width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M23 2.88675C26.094 1.10042 29.906 1.10042 33 2.88675L47.2487 11.1132C50.3427 12.8996 52.2487 16.2008 52.2487 19.7735V36.2265C52.2487 39.7992 50.3427 43.1004 47.2487 44.8868L33 53.1133C29.906 54.8996 26.094 54.8996 23 53.1132L8.75129 44.8867C5.65728 43.1004 3.75129 39.7992 3.75129 36.2265V19.7735C3.75129 16.2008 5.65728 12.8996 8.75129 11.1132L23 2.88675Z" fill="#DBBC7E" />
                                    <path d="M28.2 39.4C34.3856 39.4 39.4 34.3856 39.4 28.2C39.4 22.0144 34.3856 17 28.2 17C22.0144 17 17 22.0144 17 28.2C17 34.3856 22.0144 39.4 28.2 39.4Z" stroke="white" stroke-width="2" />
                                    <path d="M28.1998 21.48V34.92M31.5598 25.4C31.5598 23.8544 30.0557 22.6 28.1998 22.6C26.344 22.6 24.8398 23.8544 24.8398 25.4C24.8398 26.9456 26.344 28.2 28.1998 28.2C30.0557 28.2 31.5598 29.4544 31.5598 31C31.5598 32.5456 30.0557 33.8 28.1998 33.8C26.344 33.8 24.8398 32.5456 24.8398 31" stroke="white" stroke-width="2" stroke-linecap="round" />
                                </svg>
                    ...
                    <Card className="bg-[#1f1f1f] border-0 h-[124px]">
                        <div className="flex items-center gap-4">
                            <div className="p-3 rounded-lg bg-[#262626]">
                                <svg width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M23 2.88675C26.094 1.10042 29.906 1.10042 33 2.88675L47.2487 11.1132C50.3427 12.8996 52.2487 16.2008 52.2487 19.7735V36.2265C52.2487 39.7992 50.3427 43.1004 47.2487 44.8868L33 53.1133C29.906 54.8996 26.094 54.8996 23 53.1132L8.75129 44.8867C5.65728 43.1004 3.75129 39.7992 3.75129 36.2265V19.7735C3.75129 16.2008 5.65728 12.8996 8.75129 11.1132L23 2.88675Z" fill="#DBBC7E" />
                                    <path d="M17 36.6C17 35.1148 17.59 33.6904 18.6402 32.6402C19.6904 31.59 21.1148 31 22.6 31H33.8C35.2852 31 36.7096 31.59 37.7598 32.6402C38.81 33.6904 39.4 35.1148 39.4 36.6C39.4 37.3426 39.105 38.0548 38.5799 38.5799C38.0548 39.105 37.3426 39.4 36.6 39.4H19.8C19.0574 39.4 18.3452 39.105 17.8201 38.5799C17.295 38.0548 17 37.3426 17 36.6Z" stroke="white" stroke-width="2" stroke-linejoin="round" />
                                    <path d="M28.2 25.4C30.5196 25.4 32.4 23.5196 32.4 21.2C32.4 18.8804 30.5196 17 28.2 17C25.8804 17 24 18.8804 24 21.2C24 23.5196 25.8804 25.4 28.2 25.4Z" stroke="white" stroke-width="2" />
                                </svg>
                            ...
                            <div>
                                ...
                                <div className="flex items-center gap-2">
                                    <h2 className="text-2xl font-bold text-white m-0">15,788</h2>
                                    <span className="text-green-500 flex items-center text-sm">
                                        <svg width="14" height="9" viewBox="0 0 14 9" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M13.446 0.464775C13.3775 0.281602 13.2465 0.13604 13.0816 0.059971C13.0005 0.0215588 12.9134 0.00118442 12.8252 0H9.45117C9.27221 0 9.10057 0.0789796 8.97402 0.219564C8.84747 0.360148 8.77637 0.550821 8.77637 0.749638C8.77637 0.948454 8.84747 1.13913 8.97402 1.27971C9.10057 1.4203 9.27221 1.49928 9.45117 1.49928H11.1989L7.42676 5.68975L5.20665 3.21595C5.14392 3.14568 5.06929 3.08992 4.98706 3.05186C4.90483 3.0138 4.81663 2.9942 4.72754 2.9942C4.63846 2.9942 4.55026 3.0138 4.46803 3.05186C4.3858 3.08992 4.31116 3.14568 4.24843 3.21595L0.199606 7.71377C0.136358 7.78346 0.0861561 7.86637 0.0518971 7.95772C0.0176382 8.04907 0 8.14705 0 8.24602C0 8.34498 0.0176382 8.44296 0.0518971 8.53431C0.0861561 8.62566 0.136358 8.70857 0.199606 8.77826C0.262338 8.84852 0.336972 8.90429 0.419203 8.94235C0.501434 8.98041 0.589635 9 0.678717 9C0.767799 9 0.856 8.98041 0.938231 8.94235C1.02046 8.90429 1.0951 8.84852 1.15783 8.77826L4.72754 4.80518L6.94765 7.27898C7.01038 7.34925 7.08502 7.40501 7.16725 7.44307C7.24948 7.48113 7.33768 7.50072 7.42676 7.50072C7.51584 7.50072 7.60404 7.48113 7.68628 7.44307C7.76851 7.40501 7.84314 7.34925 7.90587 7.27898L12.1504 2.55626V4.49783C12.1504 4.69664 12.2215 4.88732 12.348 5.0279C12.4746 5.16848 12.6462 5.24746 12.8252 5.24746C13.0042 5.24746 13.1758 5.16848 13.3024 5.0279C13.4289 4.88732 13.5 4.69664 13.5 4.49783V0.749638C13.4989 0.651677 13.4806 0.554899 13.446 0.464775Z" fill="#00FF55" />
                                        </svg>
                                        <span className='pl-1'> 25%</span>
                                    </span>
                                </div>
                            </div>
                        </div>
            ...
            <Row gutter={[16, 16]} className="mt-6">
                <Col xs={24} lg={16}>
                    <Card className="bg-[#1f1f1f] border-0" title={
                        <div className="flex items-center justify-between">
                            <h3 className="text-white text-lg font-semibold">Website visitors</h3>
                        ...
                        <div className="h-[470px]">
                            <ResponsiveContainer width="100%" height="100%">
                                <BarChart data={monthlyData}>
                                    ...
                                    <YAxis stroke="#999" />
                                    <Bar dataKey="appUser" name="App user" fill="#DBBC7E" />
                                    <Bar dataKey="activeUser" name="Active user" fill="#00FF55" />
                                    <Tooltip
                ...
                <Col xs={24} lg={8}>
                    <Card className="bg-[#1f1f1f] border-0" title={<span className="text-white">Traffic sources</span>}>
                        <div className="h-[400px] relative">
                            ...
                            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center">
                                <p className="text-gray-400 text-sm m-0">Users</p>
                                <p className="text-white text-xl font-bold m-0">3,256</p>
                                <p className="text-green-500 text-sm m-0">+35%</p>
                            </div>
                        </div>
