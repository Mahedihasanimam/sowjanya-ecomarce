...
import { Modal, Rate, Button, Table,Input, message } from "antd";
import Image from "next/image";
import avater from '../../../public/images/avater.png'
import { useRouter } from "next/navigation";
import { useSelector } from "react-redux";
import { useGetmyorderListQuery, useLeaveAreviewMutation } from "@/redux/features/users/UserApi";
...
const ProfilePage = () => {
    ...
    const columns = [
        ...
        },
        {
            ...
            render: (status) => (
                <span
                    className={`px-2 py-1 rounded text-white ${status === "Delivered" ? "bg-green-800" : "bg-red-700"
                        }`}
                >
                    {status}
                </span>
